    ...
    Program: {
      enter(path, state) {
        if (hasJSX(path)) {
          ...
          if ((0, import_helper_module_imports.isModule)(path)) {
            const importMap = {};
            ...
            importNames.forEach((name) => {
              state.set(name, () => {
                ...
                const identifier4 = (0, import_helper_module_imports.addNamed)(path, name, librarySource, {
            ...
            importNames.forEach((name) => {
              state.set(name, () => {
                if (!sourceName) {
                  sourceName = (0, import_helper_module_imports.addNamespace)(path, "vue", {
                    ensureLiveReference: true
                  });
                }
